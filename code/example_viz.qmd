...
#   geom_point(data = spp, aes(x = avg_lon, y = avg_lat, color = year), size = 3, alpha = 10) +
...
# # 
# gganimate::animate(map_ani, fps = 10, width = 1, height = 1, units = "in", res = 550) -> map_final # width = 3, height = 3, units = "in",
